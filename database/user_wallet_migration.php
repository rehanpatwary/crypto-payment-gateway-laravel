...
return new class extends Migration
{
    public function up()
    {
        // Users table (extend if using default Laravel users)
        if (!Schema::hasTable('users')) {
            Schema::create('users', function (Blueprint $table) {
                ...
                $table->json('webhook_events')->nullable(); // ['payment_received', 'payment_confirmed']
                $table->rememberToken();
                $table->timestamps();
            });
        } else {
            ...
            Schema::table('users', function (Blueprint $table) {
                ...
                if (!Schema::hasColumn('users', 'webhook_enabled')) {
                    $table->boolean('webhook_enabled')->default(false)->after('webhook_url');
                }
                if (!Schema::hasColumn('users', 'webhook_events')) {
